...
async def async_request_tx_completions(
    ...
    async with (_create_bench_client_session() as session):
        payload = {
            ...
            "messages":  [{"role": "user", "content": prompt}] if not isinstance(prompt, list) else prompt,
            "temperature": 0.0,
...
def get_dataset(args, tokenizer):
    ...
    elif args.dataset_name == "tx":
        input_requests = sample_tx_requests(
            dataset_path=args.dataset_path,
            num_requests=args.num_prompts,
            tokenizer=tokenizer,
            fixed_output_len=args.sharegpt_output_len,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="sharegpt",
        choices=["sharegpt", "random", "random-ids", "generated-shared-prefix", "mmmu", "tx"],
